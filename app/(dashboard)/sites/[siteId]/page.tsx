                ...
                <div className="">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Manage your articles here. You can create, edit and delete your articles.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                <TableBody>
                                    {data.map((item) => (
                                        <TableRow key={item.id}>
                                            <TableCell>
                                                <Image src={item.image} alt='Article Cover Image'
                                                    width={64} height={64} className='size-16 rounded-md object-cover' />
                                            </TableCell>
